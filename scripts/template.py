...
f = open(f"../src/main/kotlin/com/clouddjr/advent2025/Day{day}.kt", "w")
fileContent = f'''package com.clouddjr.advent2025
...
f = open(f"../src/test/kotlin/com/clouddjr/advent2025/Day{day}Test.kt", "w")
fileContent = f'''package com.clouddjr.advent2025

import com.clouddjr.advent2025.Resources.{loadResourceMethod}
...
res = requests.get(f"https://adventofcode.com/2025/day/{args.day}/input", cookies={'session': session})
